package md5231efc97a6151185c9b712b3c792e3fb;


public class ChatPickerController
...
/** @hide */
	...
	static {
		__md_methods = 
			"";
		mono.android.Runtime.register ("ApplikasjonBoknaden.Droid.Controllers.Chat.ChatPickerController, ApplikasjonBoknaden.Droid, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", ChatPickerController.class, __md_methods);
	}


	public ChatPickerController (android.content.Context p0) throws java.lang.Throwable
	{
		super (p0);
		if (getClass () == ChatPickerController.class)
			mono.android.TypeManager.Activate ("ApplikasjonBoknaden.Droid.Controllers.Chat.ChatPickerController, ApplikasjonBoknaden.Droid, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "Android.Content.Context, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", this, new java.lang.Object[] { p0 });
	}


	public ChatPickerController (android.content.Context p0, android.util.AttributeSet p1) throws java.lang.Throwable
	{
		super (p0, p1);
		if (getClass () == ChatPickerController.class)
	...
	public ChatPickerController (android.content.Context p0, android.util.AttributeSet p1, int p2) throws java.lang.Throwable
	{
		super (p0, p1, p2);
		if (getClass () == ChatPickerController.class)
	...
	public ChatPickerController (android.content.Context p0, android.util.AttributeSet p1, int p2, int p3) throws java.lang.Throwable
	{
		super (p0, p1, p2, p3);
		if (getClass () == ChatPickerController.class)

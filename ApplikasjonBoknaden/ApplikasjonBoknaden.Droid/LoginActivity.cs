    ...
    public class LoginActivity : FragmentActivity
    {
      ...
      // }
        ...
        private void PopupRegisterPage()
        {
            ...
            View v = LayoutInflater.Inflate(Resource.Layout.RegisterNewUserFragmentLayout, null);
            alert.SetView(v);
            alert.Create().Show();
            RegisterNewUserActivity RegisterNewUserActivity = new RegisterNewUserActivity();
        ...
        protected void SetButtonValues()
        {
            ...
            RegisterButton.Click += delegate {
                ...
                // PopupRegisterPage();
                // StartActivity(typeof(RegisterNewUserActivity));
            };
        }
